(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vueinstaembed"] = factory();
	else
		root["vueinstaembed"] = factory();
...
// CONCATENATED MODULE: ./src/instaEmbed.js
...
/* harmony default export */ var instaEmbed = ({
  ...
  methods: {
    ...
    validateUrl: function validateUrl() {
      var urlRe = /(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})/gi;

      if (!urlRe.test(this.url)) {
        throw new Error("".concat(this.url, " - Invalid url"));
      }
    },
...
/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (instaEmbed);
...
//# sourceMappingURL=vueinstaembed.umd.js.map